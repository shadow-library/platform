...
export class ServerErrorCode extends ErrorCode {
  ...
  static readonly S004 = new ServerErrorCode('S004', ErrorType.CLIENT_ERROR, 'Request body is too large', 413);
  /** Request body size did not match Content-Length */
  static readonly S005 = new ServerErrorCode('S005', ErrorType.CLIENT_ERROR, 'Request body size did not match Content-Length');
  /** Body cannot be empty when content-type is set to 'application/json' */
  static readonly S006 = new ServerErrorCode('S006', ErrorType.CLIENT_ERROR, "Body cannot be empty when content-type is set to 'application/json'");
  /** Received media type is not supported */
  static readonly S007 = new ServerErrorCode('S007', ErrorType.CLIENT_ERROR, 'Received media type is not supported', 415);
}
