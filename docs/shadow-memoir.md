...
Gamified, single-owner life tracker: quests, hero progression, personal finance, quick logs, AI insights. Offline-first PWA (`shadow-memoir-web`) plus API (`shadow-memoir-server`).
