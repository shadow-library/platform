...
- [x] R3 — Arc module & gates: arc CRUD/approve/backfill, `targetChapterCount` volume approve with cumulative chapter mapping, generation precheck (refinement §4, §8). Verify: gate-matrix tests (legacy vs arc projects).
