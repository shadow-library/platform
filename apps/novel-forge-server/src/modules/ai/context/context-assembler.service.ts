...
function makeSection(key: string, content: string, tier: ContextTier, sourceRefs: string[] = []): ContextSection {
...
export class ContextAssembler {
  ...
  private async finalize(
    ...
    const rendered = joinSections(fittingSections);
    ...
    return { projectId, purpose, chapter, budgetTokens, usedTokens, sections: fittingSections, unresolvedRefs, rendered, id };
  }
}
