...
export class ListChaptersQuery extends PaginationQuery(SortByTime) {
  @Field(() => ChapterStatus, { optional: true }) status?: Chapter.Status;
}
...
export class ChapterListResponse {
  ...
  @Field(() => Integer) number: number;
  @Field({ optional: true, nullable: true }) title?: string | null;
  @Field({ optional: true, nullable: true }) url?: string | null;
  @Field(() => Integer, { optional: true, nullable: true }) wordCount?: number | null;
  @Field(() => ChapterStatus) status: Chapter.Status;
  @Field({ optional: true, nullable: true }) generator?: string | null;
  @Field() continuityApplied: boolean;
  @Field(() => String, { optional: true, nullable: true, format: 'date-time' }) scrapedAt?: Date | null;
...
export class ChapterResponse extends ChapterListResponse {
  @Field({ optional: true, nullable: true }) content?: string | null;
...
export class UpdateChapterBody {
  ...
  @Field({ optional: true }) content?: string;
}
