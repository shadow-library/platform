...
export class IngestBody {
  ...
  @Field(() => Integer, { optional: true }) delayMs?: number;
}

@Schema()
export class ExtractBody {
  @Field(() => Integer, { optional: true }) limit?: number;
  @Field({ optional: true }) rearm?: boolean;
}
...
export class ConsolidateResponse {
  @Field(() => Integer) significanceUpdated: number;
  @Field(() => Integer) relationshipsPromoted: number;
}
...
export class SkeletonResponse {
  @Field(() => Object) characterArcs: unknown;
  @Field() powerCurve: string;
}
