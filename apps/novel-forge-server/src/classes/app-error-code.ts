...
export class AppErrorCode extends ServerErrorCode {
  ...
  static readonly AI_003 = AppErrorCode.badRequest('AI_003', 'Unrestricted projects and unrestricted-generation operations may only use models that will generate this content');
