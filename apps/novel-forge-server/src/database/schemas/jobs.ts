...
import { bigint, bigserial, index, integer, jsonb, pgEnum, pgTable, smallint, text, timestamp, unique, uuid, varchar } from 'drizzle-orm/pg-core';
...
export const jobKind = pgEnum('job_kind', ['ingest', 'extract', 'generate', 'finalize', 'backfill', 'resume']);
