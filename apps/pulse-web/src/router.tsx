 ...
 * shared preload/staleness/pending defaults — so this app only supplies its own error screen.
 *
 ...
 */
const buildRouter = () => createAppRouter(routeTree, { router: { defaultErrorComponent: RouteError } });
