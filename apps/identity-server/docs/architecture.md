...
| `POST /oauth2/token`                    | `authorization_code`, `refresh_token`, `client_credentials` (secret or k8s SA-token client assertion, D-16) |
