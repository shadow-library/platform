...
@Module({
  ...
  controllers: [AdminUserController, AdminApplicationController, AdminClientController, AdminResourceController, AdminRoleController, AdminSamlController, AdminWebhookController],
