  ...
  return (
    <Screen title="Settings" subtitle="Your day, your money, how the app behaves, and every right you have over what it holds.">
      ...
      >
        <Card padding="lg">
          <Card.Body>
            <h2 className={styles.sectionTitle}>Profile in Memoir</h2>
            ...
            <p className={styles.sectionNote}>
              Your name, email and picture come from your Shadow account and are managed there. Nothing on this screen changes them, and Memoir stores only a copy for display.
            </p>
            <DataState
              query={deck}
              size="inline"
