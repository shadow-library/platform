  ...
  return (
    <>
      ...
      <OverlaySurface
        ...
        description="On your other device, open Memoir in its browser and choose install. This is what it offers there — nothing is installed from here."
        footer={
      ...
      >
        <p className={styles.lead}>
          {updateWaiting
            ...
            : 'This device already runs the newest version of Memoir.'}
        </p>
      </OverlaySurface>
      ...
      >
        <div className={styles.body}>
          <p className={styles.lead}>Nothing has arrived here yet. Memoir sends what you choose by email rather than to an in-app inbox.</p>
