...
const LAST_ACCOUNT_KEY = 'memoir:last-account';
...
const STORE_UNAVAILABLE =
  "Memoir keeps your day on this device and syncs it afterwards, so it can't show anything until the store opens. " +
