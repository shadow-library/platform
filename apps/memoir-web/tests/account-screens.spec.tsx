...
describe('App and sync', () => {
  ...
  it('should confirm before removing a device', async () => {
    ...
    fireEvent.click(await screen.findByRole('button', { name: 'Remove Memoir · iPhone' }));

    const dialog = await screen.findByRole('alertdialog');
    expect(dialog.textContent).toContain('Remove “Memoir · iPhone”?');
    ...
    const pending = await screen.findByRole('button', { name: 'Remove Memoir · iPhone' });
