...
const FAILURE_COPY: Record<Exclude<SyncFailureReason, 'deletion-pending'>, FailureCopy> = {
  server: {
    ...
    description: "Shadow Memoir didn't respond. Anything you log on this device is kept and syncs once it's reachable.",
    retryable: true,
  },
  offline: {
  ...
  return (
    <div role="status">
      <EmptyState
        ...
        description="Shadow Memoir is erasing this account, so there is nothing left to show here."
