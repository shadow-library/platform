...
describe('formatLocalTime', () => {
  ...
  it('should render 24-hour, not 12-hour, regardless of locale', () => {
    expect(formatLocalTime('2026-09-13T00:41:00.000Z')).toBe('02:41');
  });
...
describe('formatLocalDate', () => {
  ...
  it('should not parse a YYYY-MM-DD date as UTC midnight and shift it a day', () => {
    expect(formatLocalDate('2026-05-17')).toBe('17 May 2026');
  });

  it('should convert a UTC instant to the day it falls on locally, even across midnight', () => {
    expect(formatLocalDate('2026-09-13T23:30:00.000Z')).toBe('14 Sep 2026');
  });

  it('should support a long month with no year', () => {
    expect(formatLocalDate('2026-09-07T22:41:00.000Z', { month: 'long', year: false })).toBe('8 September');
  });
