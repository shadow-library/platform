...
export const AUDIENCE = 'api://memoir';
export const CLIENT_ID = 'memoir';
export const CLIENT_SECRET = 'memoir-test-secret';
export const OTHER_SERVICE_CLIENT_ID = 'memoir-worker';
