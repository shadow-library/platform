...
/** The FE wire format is `${questId}:${date}` (`apps/memoir-web/src/lib/data/fixture-provider.ts`); parsed here so every action command shares one occurrence identity. */
