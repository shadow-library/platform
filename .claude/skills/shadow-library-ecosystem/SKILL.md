...
| #   | Rule                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            | Instead of                                                                                                                                                                                                                                    |
| --- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 1   | MUST read env/config via `Config` (`common`); MUST NOT read `process.env` in app code                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           | Only exception: infra scripts that run outside the app (e.g. `src/migrate.ts` — backends have no `drizzle.config.ts`; `scripts/db.ts <workspace> generate` derives schema/out/dialect by convention instead) |
...
- [ ] `bun scripts/verify.ts <workspace>` passes for every changed workspace (add `--fix` for autofixable
      ...
      key sets `verifyTest`.
- [ ] Type-appropriate build/tests run: backend → `bun scripts/verify.ts <workspace> --unit` (unit tests
      only, no infrastructure needed — see `references/testing.md`); library/component →
      `bun scripts/build.ts <workspace>`; spa/ssr → the same build and the app's own e2e suite when UI
      behaviour changed.
